...
if(urlParams){
    ...
    switch(parseInt(up.m)){
        case 1:
            ...
            break;
        case 2:
            var numSim = new Secant( G, parseInt(up.x[1]), parseInt(up.x[0]), parseFloat(urlParams.tol), false );
            break;
        case 3:
            var numSim = new Newton( G, parseInt(up.x[0]), parseFloat(urlParams.tol), false );
            break;
        default:
